...
namespace Chacrutaria.Areas.Admin.Controllers
{
    [Area("Admin")]
    ...
    public class AdminProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,Nome,Descricao,DescDetalhada,Preco,ImagemUrl,ImagemMinilUrl,CarneDestaque,TemEstoque,CategoriaId")] Produto produto)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categorias, "CategoriaId", "Categoria", produto.CategoriaId);
            return View(produto);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,Nome,Descricao,DescDetalhada,Preco,ImagemUrl,ImagemMinilUrl,CarneDestaque,TemEstoque,CategoriaId")] Produto produto)
        {
