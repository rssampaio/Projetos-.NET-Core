...
namespace Chacrutaria.Services
{
    public class CarrinhoService
    {
        ...
        public void AdcionarAoCarrinho(Produto produto, int quantidade)
        {
            var carrinhoCompraItem = _context.CarrinhoCompraItens.SingleOrDefault(
                p => p.Produto.ProdutoId == produto.ProdutoId && p.CarrinhoCompraId == _carrinhoCompra.CarrinhoCompraId);
        ...
        public List<CarrinhoCompraItem> GetCarrinhoCompraItems()
        {
            return _carrinhoCompra.CarrinhoCompraItems ??
                ...
                _context.CarrinhoCompraItens.Where(p => p.CarrinhoCompraId == _carrinhoCompra.CarrinhoCompraId)
                .Include(p => p.Produto)
                .ToList()
                );
        }
        ...
        public void LimparCarrinho()
        {
            var carrinhoItens = _context.CarrinhoCompraItens.Where(
                carrinho => carrinho.CarrinhoCompraId == _carrinhoCompra.CarrinhoCompraId);
        ...
        public decimal GetCarrinhoTotalCompra()
        {
            var total = _context.CarrinhoCompraItens.Where(
                p => p.CarrinhoCompraId == _carrinhoCompra.CarrinhoCompraId)
